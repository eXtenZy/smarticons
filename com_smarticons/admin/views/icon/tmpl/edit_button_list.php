...
<div class="row-fluid">
	<div class="list">
		<a id="list_url" style="<?php echo $linkStyle; ?>" target="_blank" href="<?php echo $this->item->Target; ?>" title="<?php echo isset($this->item->Title) ? JText::_($this->item->Title) : ''; ?>">
			<i id="list_icon" style="<?php echo $this->displayIconControl ? 'display:inline' : 'display:none'; ?>"><?php echo $this->item->icon; ?></i>
			...
			<span id="list_text" style="<?php echo $textStyle;?>"><?php echo JText::_($this->item->Name); ?></span>
		</a>
	</div>
</div>
